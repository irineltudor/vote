...
contract ElectionFinalTest{
    ...
    function resetVoteForAddress(address voterAddress) public ownerOnly{
        uint who= _eligibleVoters[voterAddress].whom;
        _eligibleVoters[voterAddress].voted = false;
        _totalVotes -= 1;
        _candidates[who].numVotes -= 1;
    }
   
    function setDate(uint startDate_,uint duration_) public ownerOnly{
        _startDate = startDate_;
        _duration = duration_;
    }
    //------------------------------------ 
